...
class StudentForm(forms.ModelForm):
    ...
    class Meta:
        model = Student 
        fields = ['gender','dob','profile_picture','address','country','state','city','zip_code','latitude','longitude','subjects','preferred_gender','additional_information','preferred_tutor_level'] 
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
