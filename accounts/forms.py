...
class TutorForm(forms.ModelForm):
    ...
    qualification_information = forms.CharField(
                    widget=forms.Textarea(attrs={'placeholder': 'Please include any information that you think will help boost your credibility as a tutor. e.g Current University Course, Past Experience'}))
